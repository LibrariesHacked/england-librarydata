...
with open('librariesgeo.csv', 'r') as libscsv:
    ...
    for row in reader:
        # id,name,address,postcode,st_astext,lat,lng
        id = row[0]
        name = row[1]
        address = row[2]
        postcode = row[3]
        ...
        #http://nominatim.openstreetmap.org/search/York+Explore+Library+Square+York?viewbox=-1.22371196679726,54.0568663596222,-0.919670778852277,53.8745672170754&format=json&bounded=1&limit=1