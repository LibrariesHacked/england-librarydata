$(function () {
    ...
    var displayLib = function () {
        ...
        $('#divLibraryLinks').append('<p>' +
            (library.email ? '<a href="mailto:' + library.email + '" target= "_blank" class="btn btn-secondary" title="email ' + library.name + '"> <span class="fas fa-envelope"></span> email</a > ' : '') +
            (library.url ? '<a href="' + (library.url.indexOf('http') == -1 ? 'http://' + library.url : library.url) + '" target="_blank" class="btn btn-secondary" title="go to ' + library.name + ' website"><span class="fas fa-external-link"></span>&nbsp;website</a>' : '') +
            '</p>'
        );
        ...
        $('#sidebar-librarycontent').append(
            '<div class="row">' +
            '<div class="col-4"><small class="text-muted">statutory&nbsp;<a href="#" class="fas fa-info" data-toggle="tooltip" data-animation="false" title="is the library part of the local authority statutory provision?"></a></small><p class="lead text-gray-dark">' + (library.statutory2016 == 't' ? 'yes' : 'no') + '</p></div>' +
            '<div class="col-4"><small class="text-muted">hours&nbsp;<a href="#" class="fas fa-info" data-toggle="tooltip" data-animation="false" title="number of hours open per week"></a></small><p class="lead text-gray-dark">' + (library.hours ? library.hours : '0') + '</p></div>' +
            '<div class="col-4"><small class="text-muted">staff hours&nbsp;<a href="#" class="fas fa-info" data-toggle="tooltip" data-animation="false" title="number of staff hours per week"></a></small><p class="lead ' + (library.staffhours && library.staffhours != 0 ? ('text-gray-dark">' + library.staffhours) : 'text-danger">0') + '</p></div>' +
            '</div>' +
            '<div class="row">' +
            '<div class="col-4"><small class="text-muted">people&nbsp;<a href="#" class="fas fa-info" data-toggle="tooltip" data-animation="false" title="total population in the library catchment (mid-2015 estimate)"></a></small><p class="lead text-' + config.depStatStyles[library.population] + '">' + LibrariesFuncs.getNumFormat(library.population) + '</p></div>' +
            '<div class="col-4"><small class="text-muted">adults&nbsp;<a href="#" class="fas fa-info" data-toggle="tooltip" data-animation="false" title="number of adults 16 and over"></a></small><p class="lead text-' + config.depStatStyles[library.population_adults] + '">' + LibrariesFuncs.getNumFormat(parseInt(library.sixteen_fiftynine) + parseInt(library.over_sixty)) + '</p></div>' +
            '<div class="col-4"><small class="text-muted">children&nbsp;<a href="#" class="fas fa-info" data-toggle="tooltip" data-animation="false" title="number of children under 16"></a></small><p class="lead text-' + config.depStatStyles[library.population_children] + '">' + LibrariesFuncs.getNumFormat(library.dependent_children) + '</p></div>' +
            '</div>');
        ...
        $('#sidebar-librarycontent').append(
            ...
            '<div class="row">' +
            '<div class="col-4"><small class="text-muted">multiple&nbsp;<a href="#" class="fas fa-info" data-toggle="tooltip" data-animation="false" title="a combination of deprivation measures to give an overall deprivation index"></a></small><p class="lead text-' + config.depStatStyles[parseFloat(library.multiple).toFixed(0)] + '">' + parseFloat(library.multiple).toFixed(0) + '</p></div>' +
            '<div class="col-4"><small class="text-muted">work&nbsp;<a href="#" class="fas fa-info" data-toggle="tooltip" data-animation="false" title="employment deprivation for the library catchment"></a></small><p class="lead text-' + config.depStatStyles[parseFloat(library.employment).toFixed(0)] + '">' + parseFloat(library.employment).toFixed(0) + '</p></div>' +
            '<div class="col-4"><small class="text-muted">education&nbsp;<a href="#" class="fas fa-info" data-toggle="tooltip" data-animation="false" title="education deprivation for the library catchment"></a></small><p class="lead text-' + config.depStatStyles[parseFloat(library.education).toFixed(0)] + '">' + parseFloat(library.education).toFixed(0) + '</p></div>' +
            '</div>' +
            '<div class="row">' +
            '<div class="col-4"><small class="text-muted">adult skills&nbsp;<a href="#" class="fas fa-info" data-toggle="tooltip" data-animation="false" title="adult skills and training deprivation for the library catchment"></a></small><p class="lead text-' + config.depStatStyles[parseFloat(library.adultskills).toFixed(0)] + '">' + parseFloat(library.adultskills).toFixed(0) + '</p></div>' +
            '<div class="col-4"><small class="text-muted">health&nbsp;<a href="#" class="fas fa-info" data-toggle="tooltip" data-animation="false" title="health deprivation for the library catchment"></a></small><p class="lead text-' + config.depStatStyles[parseFloat(library.health).toFixed(0)] + '">' + parseFloat(library.health).toFixed(0) + '</p></div>' +
            '<div class="col-4"><small class="text-muted">services&nbsp;<a href="#" class="fas fa-info" data-toggle="tooltip" data-animation="false" title="geographical access to services deprivation for the library catchment"></a></small><p class="lead text-' + config.depStatStyles[parseFloat(library.services).toFixed(0)] + '">' + parseFloat(library.services).toFixed(0) + '</p></div>' +
            '</div>');
        updateTooltips();
    ...
    var displayOutputArea = function (feature) {
        ...
        $('#sidebar-oacontent').append(
            '<br/><div class="row">' +
            '<div class="col-4"><small class="text-muted">people&nbsp;<a href="#" class="fas fa-info" data-toggle="tooltip" data-animation="false" title="total population in the output area (mid-2015 estimate)"></a></small><p class="lead text-muted">' + LibrariesFuncs.getNumFormat(feature.properties.all_ages) + '</p></div>' +
            '<div class="col-4"><small class="text-muted">adults&nbsp;<a href="#" class="fas fa-info" data-toggle="tooltip" data-animation="false" title="number of adults 16 and over"></a></small><p class="lead text-muted">' + LibrariesFuncs.getNumFormat(parseInt(feature.properties.sxt_fynn) + parseInt(feature.properties.ovr_sxty)) + '</p></div>' +
            '<div class="col-4"><small class="text-muted">children&nbsp;<a href="#" class="fas fa-info" data-toggle="tooltip" data-animation="false" title="number of children under 16"></a></small><p class="lead text-muted">' + LibrariesFuncs.getNumFormat(feature.properties.children) + '</p></div>' +
            '</div>');
